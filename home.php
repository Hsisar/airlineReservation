...
<h2>လေယာဉ်လမ်းကြောင်းရှာဖွေရန်</h2>
    ...
    <td colspan="2"><b><input type="radio" name="link" value="oneway" onclick="Change_Form()">အသွားတစ်ကြောင်း</b></td></tr>
    <tr>
    ...
    <td><label for="aplace"><b>ပြန်လည်ထွက်ခွါမည့်နေရာ</b></label></td>
    <td><select name="lplace" id="lplace">
                <option value="lplace"></option>
                <optgroup label="မြန်မာ(Myanmar)">
                    <option value="">ရန်ကုန်</option>
...
<tr>
    ...
    <tr>
    <td><label for="aday"><b>ပြန်လည်ထွက်ခွါမည့်မည့်ရက်</b></label></td>
    <td><input type="date" placeholder="Choose" name="aday" id="aday" required></td><td colspan="2">
    <select placeholder="Anytime" name="time" id="time">
                <option value="time"></option>
                <option value="time1">1:00AM</option>
                <option value="time2">2:00AM</option>
                <option value="time3">3:00AM</option>
